...
public class funnelScript : MonoBehaviour
{
    ...
    public float cooldownFinal = 0.5f;  // segundos de cooldown despu�s de instanciar
    ...
    private IEnumerator IniciarCoroutine()
    {
        ...
        {
            Debug.LogWarning("pelotaPrefab o pelotas1 no est�n asignados.");
        }
        ...
        {
            Debug.LogWarning("pelotaPrefab o pelotas2 no est�n asignados.");
        }
